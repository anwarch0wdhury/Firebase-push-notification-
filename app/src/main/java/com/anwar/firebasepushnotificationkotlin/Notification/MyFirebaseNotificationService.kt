...
import com.anwar.firebasepushnotificationkotlin.Activity.NotificationShowActivity
...
class MyFirebaseNotificationService : FirebaseMessagingService() {
    ...
    private fun handleDataMessage(json: JSONObject) {
        ...
        try {
            ...
            //Send notification data to NotificationShowActivity class for showing
            val resultIntent = Intent(applicationContext, NotificationShowActivity::class.java)
